...
public class Order_Type extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(firebaseAuth.getCurrentUser() == null){
            ...
            Intent intent = new Intent(Order_Type.this, LoginActivity.class);
            startActivity(intent);

            Toast.makeText(Order_Type.this, "Please Log in to continue", Toast.LENGTH_LONG).show();
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Order_Type.this, "Logged Out Successfully.", Toast.LENGTH_LONG).show();
